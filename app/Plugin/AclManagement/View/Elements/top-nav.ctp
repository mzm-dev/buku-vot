...
if ($this->Session->check('Auth.User.id')) {
    ...
    <ul class="nav" data-dropdown="dropdown">
        <li class="menu">
            <a class="menu" href="#" class="dropdown-toggle">Project</a>
            <ul class="menu-dropdown">
                <li><a href="<?php echo $this->Html->url('/directories'); ?>">Manage Project</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo $this->Html->url('/directories/add'); ?>">New Project</a></li>
            </ul>
        </li><li class="menu">
